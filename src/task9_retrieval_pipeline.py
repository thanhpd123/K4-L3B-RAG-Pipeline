...
def retrieve(
    ...
    # Dense results are sorted descending by contract. Do not compare an RRF
    # score (a rank-fusion value) with a cosine-similarity threshold.
    ...
    if best_dense_score < score_threshold:
        try:
            ...
            # PageIndex is optional. Retrieval must remain available when the
            # external provider is unconfigured, unavailable, or still indexing.
